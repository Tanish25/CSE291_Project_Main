...
class PlaceDB (object):
    ...
    def __init__(self):
        ...
        #self.routing_grid_xl = 1.08#Tanish
        #self.routing_grid_yl = 1.08#Tanish
        #self.routing_grid_xh = 15.12#Tanish
        #self.routing_grid_yh = 15.12#Tanish
    ...
    def initialize_from_rawdb(self, params):
        ...
        self.xl = 0#Tanish
        self.yl = 0#Tanish
        self.xh = 16200#Tanish
        self.yh = 16200#Tanish
        ...
        self.routing_grid_xl = 1080#Tanish
        self.routing_grid_yl = 1080#Tanish
        self.routing_grid_xh = 15120#Tanish
        self.routing_grid_yh = 15120#Tanish
